...
# Ensure SteamCMD box86 wrapper is in place (self-healing)
if [ -f "/home/steam/steamcmd/linux32/steamcmd" ] && [ "$(head -c 2 /home/steam/steamcmd/linux32/steamcmd)" != "#!" ]; then
  echo "Restoring SteamCMD box86 wrapper..."
  mv /home/steam/steamcmd/linux32/steamcmd /home/steam/steamcmd/linux32/steamcmd.real
  echo -e '#!/bin/bash\nexec /usr/local/bin/box86 /home/steam/steamcmd/linux32/steamcmd.real "$@"' > /home/steam/steamcmd/linux32/steamcmd
